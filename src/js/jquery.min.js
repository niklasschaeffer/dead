...
! function(a, b) {
    ...
    r.fn = r.prototype = {
        ...
        map: function(a, b, c) {
            var d, e, f = 0,
                h = [];
            if (w(a)) for (d = a.length; d > f; f++) e = b(a[f], f, c), null != e && h.push(e);
    ...
    var x = function(a) {
        ...
        function ya(a) {
            for (var b, c, e, f = a.length, g = d.relative[a[0].type], h = g || d.relative[" "], i = g ? 1 : 0, k = ta(function(a) {
                ...
                return b = null, e
            }]; f > i; i++) if (c = d.relative[a[i].type]) m = [ta(ua(m), c)];
            else {
    ...
    function oa(a, b, c, d, e) {
        for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; o > n; n++) if (f = a[n], f || 0 === f) if ("object" === r.type(f)) r.merge(m, f.nodeType ? [f] : f);
        else if (na.test(f)) {
    ...
    r.extend({
        ...
        clone: function(a, b, c) {
            ...
            if (b) if (c) for (f = f || la(a), g = g || la(h), d = 0, e = f.length; e > d; d++) Fa(f[d], g[d]);
            else Fa(a, h);
